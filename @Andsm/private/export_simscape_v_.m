function export_simscape_v_(model, pathstr, filename, label, option)
% export_simscape_v_ export model into a Simscape model
% 
% Example: 
% 
% export_simscape_v_(model, '~/workspace', 'filename', 'modelname', option)
%
% option may contain
...
for i = 1:model.m
    fprintf(fout, '    u(%d) == (p%d.v - n.v) ./ unit_v;\n', i, i);
end
fprintf(fout, '    let\n');
